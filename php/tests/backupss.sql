...
CREATE TABLE `seats` (
  ...
  PRIMARY KEY (`SeatNo`,`ProdNo`),
  KEY `SeatNo` (`SeatNo`),
  KEY `ProdNo` (`ProdNo`),
  KEY `Title` (`Title`,`Date`),
  CONSTRAINT `seats_ibfk_1` FOREIGN KEY (`ProdNo`) REFERENCES `production` (`ProdNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `seats_ibfk_2` FOREIGN KEY (`Title`, `Date`) REFERENCES `production` (`Title`, `Date`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`TicketID`,`UserID`,`SeatNo`,`ProdNo`),
  KEY `TicketID` (`TicketID`,`SeatNo`),
  KEY `SeatNo` (`SeatNo`),
  KEY `UserID` (`UserID`),
  KEY `ProdNo` (`ProdNo`),
  KEY `Title` (`Title`,`Date`),
  CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`SeatNo`) REFERENCES `seats` (`SeatNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tickets_ibfk_6` FOREIGN KEY (`Title`, `Date`) REFERENCES `production` (`Title`, `Date`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tickets_ibfk_7` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tickets_ibfk_8` FOREIGN KEY (`ProdNo`) REFERENCES `seats` (`ProdNo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `translogs` VALUES ('Insert on Users','2016-05-25 20:35:22'),('Add on Administrator','2016-05-25 20:50:17'),('Delete on Users','2016-05-25 21:14:14'),('Insert on Users','2016-05-25 21:17:16');
...
-- Dump completed on 2016-05-25 22:31:59
